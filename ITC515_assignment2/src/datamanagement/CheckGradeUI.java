...
public class CheckGradeUI extends javax.swing.JFrame implements IUnitLister,
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		...
		jlabel6.setText("");
		try {
			control.saveGrade(asg1, asg2, exam);
	...
	public void clearUnits() {
		...
		box1.addElement("<none selected>");
		clearStudents();
	}

	public void addUnit(IUnit u) {
		box1.addElement(u.getUnitCode());
	}
	...
	public void clearStudents() {
		...
		box2.addElement("<none selected>");
	}

	public void addStudent(IStudent student) {
		box2.addElement(student.getID().toString() + " : "
